            ...
            <div className="card" style={{ marginBottom: '20px' }}>
                ...
                <div className="form-row">
                    <div className="form-group">
                        <label htmlFor="filter-computer-name">Computer Name</label>
                        <input id="filter-computer-name" type="text" value={filters.computerName} onChange={(e) => setFilters({ ...filters, computerName: e.target.value })} placeholder="Filter by computer name" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="filter-start-date">Start Date</label>
                        <input id="filter-start-date" type="date" value={filters.startDate} onChange={(e) => setFilters({ ...filters, startDate: e.target.value })} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="filter-end-date">End Date</label>
                        <input id="filter-end-date" type="date" value={filters.endDate} onChange={(e) => setFilters({ ...filters, endDate: e.target.value })} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="filter-limit">Limit</label>
                        <select id="filter-limit" value={filters.limit} onChange={(e) => setFilters({ ...filters, limit: e.target.value })}>
