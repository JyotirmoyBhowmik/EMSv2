        ...
        {["all", "active", "inactive"].map((f) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              background:
                filter === f ? "var(--primary-color)" : "var(--bg-tertiary)",
              ...
              >
                ...
                <td style={tdStyle}>
                  <button
                    ...
                    style={{ ...btnStyle, background: "#1976d2" }}
                  >
                    Edit
                  </button>
                  <button
                    ...
                    style={{
                      ...btnStyle,
                      background: user.is_active ? "#d32f2f" : "#2e7d32",
                      marginLeft: "5px",
                    }}
                  >
          ...
          <div style={{ ...modalBox, maxWidth: "600px" }}>
            ...
            {activities.length === 0 ? (
              ...
              activities.map((ev, i) => (
                ...
                >
                  ...
                  >
                    {new Date(ev.timestamp).toLocaleString()} • by{" "}
            ...
            <div style={{ textAlign: "right", marginTop: "20px" }}>
              <button
                ...
                style={{ ...btnStyle, background: "var(--primary-color)" }}
              >
                Close
              </button>
            </div>
