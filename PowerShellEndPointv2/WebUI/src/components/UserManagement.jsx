            ...
            {showForm && (
                <div style={modalOverlay}>
                    <div style={modalBox}>
                        ...
                        <label htmlFor="userRole" style={{ display: 'block', marginBottom: '4px', fontWeight: '600' }}>Role</label>
                        <select id="userRole" value={form.role} onChange={e => setForm({ ...form, role: e.target.value })} style={inputStyle}>
