...
"@
                ...
                $collectionFailedRow = Invoke-PGQuery -Query "SELECT COUNT(*)::int AS count FROM v_ems_latest_compliance_classified WHERE compliance_issues ILIKE '%Inventory collection failed%';" | Select-Object -First 1
...
"@ | Select-Object -First 1
                ...
                $metricWarningRow = Invoke-PGQuery -Query "SELECT COUNT(*)::int AS count FROM v_ems_latest_compliance_classified WHERE COALESCE(compliance_warnings,'') <> '';" | Select-Object -First 1
